function copyTextToClipboard(text) {
  ...
  { re: "MCO:BGN:INIT (\\w+),CP=([^,]+),VER=(.*)", d: "Core initialization of <b>$1</b>, with capabilities $2, library version $3" },
  ...
  { re: "SGN:SKP:MSG CMD=(\\d+),TYPE=(\\d+)", d: "Message with command <b>$1</b> and type <b>$1</b> does not need to be signed" },
